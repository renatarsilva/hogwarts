                    ...
                    <div className='p-4 bg-n-7 rounded-3-xl overflow-hidden lg:min-h-[46rem]'>
                            <div className="py-12 px-4 xl:px-8">
                                <h4 className="h4 mb-4">Video generation</h4>
                                    ...
                                    The world’s most powerful AI photo 
                                    and video art generation engine. 
                                    ...
                                    <ul className="flex items-center justify-between">
                                        {brainwaveServicesIcons.map((item, index) => (
                                            <li
                                                key={index}
                                                className={`rounded-2xl flex items-center justify-center ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:w-15 md:h15'}`}>
